...
# movie titles to the database. Next, run the rapidAPI.py file 6 times to pass the rotten tomato 
# movie titles through the rapid api. This program will save the data to a json file so it will only 
# need to call the api once. The data is stored in output.json. The database will be populated 
